...
import { signInWithFacebook, signInWithGoole } from "../../store/reducers/userSlice";
import "./Login.css";
...
export const Login: FC = () => {
    ...
    return (
        <div className="login">
            ...
            <button className="login__btn" onClick={() => dispatch(signInWithFacebook())}>Login with Facebook</button>
        </div>
    )
}